...
public class Generator {
	...
	//③创建mapper配置文件
	public static ResultJson createMapperImpl(String url,BasisInfo bi) {
		...
		bi.setAgile(agile);
		return FreemarkerUtil.createFile(bi, "mapper-xml.ftl", fileUrl);
	}
	...
	public static String getGeneratorFileUrl(String url,String packageUrl,String entityName, String type){
		...
		}else if(type.equals(MAPPER_IMPL)) {
		...
		}else if(type.equals(SWAGGER_CONFIG)){
