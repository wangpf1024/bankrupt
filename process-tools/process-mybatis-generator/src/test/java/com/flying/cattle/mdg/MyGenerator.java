...
public class MyGenerator {
		...
		public static final String TABLE = "work_flow_model_info";
		public static final String CLASSCOMMENT = "流程模型";
		public static final String TIME = "2024年10月30日";
		public static final String AGILE = new Date().getTime() + "";


	    // 路径信息，分开路径方便聚合工程项目，微服务项目
		public static final String BAST_PROJECT_URL ="cn.bankrupt.workflow."+MODULE_PACKAGE+".";
