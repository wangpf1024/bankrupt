...
import com.pansome.workflow.idm.entity.WorkFlowTenant;
import com.pansome.workflow.idm.service.*;
            ...
            if(tenant != null){
                ...
                if(tenantUser != null){
                    ...
                    List<Group> groups = identityService.createGroupQuery()
                            .memberOfTenant(i.getTenantId())
                            .groupMember(i.getUserId()).list();
                    if(!CollectionUtils.isEmpty(groups)){
                        groups.stream().forEach(g ->{
                            identityService.deleteMembership(i.getUserId(),g.getId());
                        });
                    }
                }
            }
